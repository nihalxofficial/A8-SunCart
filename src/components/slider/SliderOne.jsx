...
import animationData from "@/assets/lottie-slide-1";
const SliderOne = () => {
    return (
        <div className="w-11/12 mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-20">
            <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-12">
                ...
                <div className="flex-1 space-y-6 text-center lg:text-left">
                    ...
                    <div>
                        <p className="text-amber-500 text-sm font-semibold uppercase tracking-wide mb-1">Limited Offer</p>
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                            <span className={`text-sky-600 ${pacifico.className}`}>Summer Sale</span>
                            <br />
                            <span className="text-amber-600">50% OFF</span>
